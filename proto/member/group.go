...
func SetGroup(ctx context.Context, addr gov.GovPublicAddress, name Group) {
...
func IsGroup(ctx context.Context, addr gov.GovPublicAddress, name Group) bool {
...
func AddGroup(ctx context.Context, addr gov.GovPublicAddress, name Group) {
	cloned := gov.Clone(ctx, addr)
...
func RemoveGroup(ctx context.Context, addr gov.GovPublicAddress, name Group) {
	cloned := gov.Clone(ctx, addr)
