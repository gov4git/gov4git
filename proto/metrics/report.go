...
func AssembleReport_Local(
	...
	fmt.Fprintf(&w, "|  ---:|  :--- |\n")
	fmt.Fprintf(&w, "| Number of votes made | %d |\n", int(last30DaysSeries.DailyNumVotes.Total()))
	fmt.Fprintf(&w, "| Credits spent on votes | %0.6f |\n", last30DaysSeries.DailyVoteCharges.Total())
	fmt.Fprintf(&w, "|  ---:|  :--- |\n")
	...
	fmt.Fprintf(&w, "|  ---:|  :--- |\n")
	fmt.Fprintf(&w, "| Number of votes made | %d |\n", int(allTimeSeries.DailyNumVotes.Total()))
	fmt.Fprintf(&w, "| Credits spent on votes | %0.6f |\n", allTimeSeries.DailyVoteCharges.Total())
	fmt.Fprintf(&w, "|  ---:|  :--- |\n")
